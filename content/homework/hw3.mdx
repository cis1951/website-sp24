...
[CLLocationCoordinate2D](https://developer.apple.com/documentation/corelocation/cllocation?language=swift) represents a latitude and longitude -- you can use it to represent the location of each dining hall.
...
* Lecture 7: Location and Motion
    * [Slides](https://www.seas.upenn.edu/~cis1951/lectures/07-location-and-motion/slides.pdf)
