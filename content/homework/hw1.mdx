...
We will grade your homework based on the following rubric:
...
* **Style** (20 points)
  ...
  * *5 points:* Design decisions make sense for the assignment (i.e. structs aren't just randomly placed)
  * *5 points:* README suitably describes how concepts are covered
